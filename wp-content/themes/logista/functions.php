  ...
  function ocdi_import_files() {
	return array(
		array(
			...
			'categories'                 => array( ''),
			'import_file_url'            => 'https://garantiwebdesign.com/setup/logista/demo-content.xml',
			'import_redux'               => array(

			),
			'import_preview_image_url'   => 'https://garantiwebdesign.com/setup/logista/screenshot.png',
			'import_notice'              => __( '', 'your-textdomain' ),
			'preview_url'                => 'https://www.garantiwebdesign.com/wordpress/logista',
		),
