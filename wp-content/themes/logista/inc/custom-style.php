...
.hamburger-menu span{background: <?php the_field('primary','option');?>;}
...
.box-style2.box-primary-color2::before {
    ...
    background: linear-gradient(180deg, rgba(13, 24, 32, 0) 0%, <?php the_field('secondary','option');?> 100%, rgba(0, 0, 0, 0.7) 100%);+
    border-radius: 5px;
}
...
.box-style2.box-primary-color2::after {
    ...
    width: 100%;
    height: 100%;
    background: -webkit-gradient(linear, left top, left bottom, from(rgba(0, 193, 148, 0)), color-stop(61.98%, <?php the_field('primary','option');?>e0), to(<?php the_field('primary','option');?>));
    background: linear-gradient(180deg, rgba(0, 193, 148, 0) 0%, <?php the_field('primary','option');?>e0 61.98%, <?php the_field('primary','option');?> 100%);
    bottom: 0;
    -webkit-transition: var(--transition);
    transition: var(--transition);
    opacity: 0;
...
[class^="btn-"] {
  ...
  .btn-1 {
    position: relative;
    background: <?php the_field('text_secondary_color','option');?>;;
    color: #ffffff;
    font-family:<?php the_field('heading_font','option');?>;
    height: 75px;
    line-height: 70px;
...
@keyframes criss-cross-left2 {
  ...
  .ozld {
    border: 2px solid <?php the_field('primary','option');?>;
    border-radius: 5px;
    padding-top: 16px;
    padding-bottom: 16px;
    margin-top: 12px;
...
.fq2 {background:<?php the_field('primary','option');?>;}
.col-lg-4.infs1 {
    background: none;
}
.col-lg-4.infs8 {
...
select {border-bottom: 0.3rem solid <?php the_field('primary','option');?>;margin-bottom: 17px;border-radius: 5px;}
...
.menueffect a:before {background-color: <?php the_field('secondary','option');?>; }
...
.preloader figure:after{border-top: 1px solid <?php the_field('secondary','option');?>;}
...
.sectionbars {background:<?php the_field('secondary','option');?>;}
...
.question{ font-family: <?php the_field('heading_font','option');?>; font-size:18px;color:#fff;}
.answer{color:#fff;}
...
.navbar .site-menu ul li a {font-family: <?php the_field('heading_font','option');?>;color:#000000;padding: 11px;}
...
.navbar .site-menu ul li a:before {
    ...
    width: 30px;
    height: 30px;
    background: <?php the_field('primary','option');?>26;
    top: 10px;
    left: 1px;
    bottom: 0;
    z-index: -1;
...
.wpem-event-listings .wpem-event-layout-wrapper .wpem-event-banner .wpem-event-banner-img {
    ...
    border-radius: 5px;
    background-color: <?php the_field('text_primary_color','option');?>;
}
.wpem-main a {
...
.wpem-theme-button, a.wpem-theme-button, button.wpem-theme-button, input.wpem-theme-button {background: <?php the_field('primary','option');?>;}
.wpem-main a {color:<?php the_field('primary','option');?>;}
.wpem-main a:hover {color:<?php the_field('secondary','option');?>;}
.wpem-form-wrapper .showing_applied_filters a{color:<?php the_field('primary','option');?>;}
...
.wpem-alert-danger {background:none;color:<?php the_field('primary','option');?>;border:2px solid <?php the_field('primary','option');?>;}
.wpem-event-listings-header .wpem-event-layout-action-wrapper .wpem-event-layout-action .wpem-event-layout-icon.wpem-active-layout{background-color:<?php the_field('primary','option');?>;}
/* Event Finish */
.vbtn-fluid {
    display: flex;
    justify-content: center;
...
/* service background */
.footer {background: <?php the_field('secondary','option');?>;}
