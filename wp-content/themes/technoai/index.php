...
<head>
  ...
  <title>
    Technoai - IT Solutions & Business Services Multipurpose Responsive
    Website Template
  </title>
  <meta content="" name="Technoai - IT Solutions & Business Services Multipurpose Responsive Website Template" />
  <meta name="description"
    content="Technoai - IT Solutions & Business Services Multipurpose Responsive Website Template" />
  ...
  <link href="<?php echo get_template_directory_uri(); ?>/assets/stylesheets/font-awesome.min.css" rel="stylesheet" />
  ...
  <link href="<?php echo get_template_directory_uri(); ?>/assets/vendor/bootstrap-icons/bootstrap-icons.css"
    rel="stylesheet" />
  <!-- Main CSS File -->
  <link href="<?php echo get_template_directory_uri(); ?>/assets/stylesheets/styles.css" rel="stylesheet" />
</head>
  ...
  <main id="main">
        ...
        <div class="row gy-5 position-relative">
          ...
          <div class="col-xl-4 col-md-6 service-item">
            <div class="service-card card-rotated">
              <div class="service-icon mb-3">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/icons/service-design.svg"
                  alt="Design" class="img-fluid" />
              </div>
          ...
          <div class="col-xl-4 col-md-6 service-item">
            <div class="service-card">
              <div class="service-icon mb-3">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/icons/service-hosting.svg"
                  alt="Hosting" class="img-fluid" />
              </div>
              <h4 class="service-title">Web Hosting</h4>
              <p class="service-description">
                Powerful, secure hosting services that ensure your site runs
                smoothly, 24/7.
              </p>
              <a href="#" class="btn btn-get-started">Explore</a>
            </div>
          ...
          <div class="col-xl-4 col-md-6 service-item">
            <div class="service-card card-rotated">
              <div class="service-icon mb-3">
                <img src="assets/images/icons/service-seo.svg" alt="SEO" class="img-fluid" />
              </div>
              <h4 class="service-title">SEO Optimization</h4>
              <p class="service-description">
                Enhance your online presence and drive traffic with our expert
                SEO strategies.
              </p>
              <a href="#" class="btn btn-get-started">Explore</a>
            </div>
          ...
          <div class="col-xl-4 col-md-6 service-item">
            <div class="service-card card-rotated">
              <div class="service-icon mb-3">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/icons/service-cloud.svg" alt="Cloud"
                  class="img-fluid" />
              </div>
              <h4 class="service-title">Cloud Hosting</h4>
              <p class="service-description">
                Next-generation cloud hosting for scalability and speed in
          ...
          <div class="col-xl-4 col-md-6 service-item">
            <div class="service-card card-rotated">
              <div class="service-icon mb-3">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/icons/service-secure.svg"
                  alt="Security" class="img-fluid" />
              </div>
              <h4 class="service-title">Data Security</h4>
              <p class="service-description">
                Protect your business data with our high-level security
          ...
          <!-- Service 6 -->
          <div class="col-xl-4 col-md-6 service-item">
            <div class="service-card card-rotated-2">
              <div class="service-icon mb-3">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/icons/service-social.svg"
                  alt="Social Media" class="img-fluid" />
              </div>
              <h4 class="service-title">Social Media</h4>
              <p class="service-description">
                Build a community around your brand with customized social
                media strategies.
              </p>
              <a href="#" class="btn btn-get-started">Explore</a>
            </div>
        ...
        <div class="portfolio-isotope" data-portfolio-filter="*" data-portfolio-layout="masonry"
          ...
          <div>
            <ul class="portfolio-flters">
              ...
              <li data-filter=".filter-product">Development</li>
          ...
          <div class="row gy-4 portfolio-container">
            <div class="col-xl-4 col-md-6 portfolio-item filter-app">
              <div class="portfolio-wrap">
                <a href="<?php echo get_template_directory_uri(); ?>/assets/images/portfolio/product-1.jpg"
                  data-gallery="portfolio-gallery-app" class="glightbox"><img
                    src="<?php echo get_template_directory_uri(); ?>/assets/images/portfolio/product-1.jpg"
                    class="img-fluid" alt="" />
            ...
            <div class="col-xl-4 col-md-6 portfolio-item filter-product">
              <div class="portfolio-wrap">
                <a href="<?php echo get_template_directory_uri(); ?>/assets/images/portfolio/product-2.jpg"
                  data-gallery="portfolio-gallery-app" class="glightbox"><img
                    src="<?php echo get_template_directory_uri(); ?>/assets/images/portfolio/product-2.jpg"
                    class="img-fluid" alt="" />
                  <div class="portfolio-info">
            ...
            <div class="col-xl-4 col-md-6 portfolio-item filter-branding">
              <div class="portfolio-wrap">
                <a href="<?php echo get_template_directory_uri(); ?>/assets/images/portfolio/product-3.jpg"
                  data-gallery="portfolio-gallery-app" class="glightbox"><img
                    src="<?php echo get_template_directory_uri(); ?>/assets/images/portfolio/product-3.jpg"
                    class="img-fluid" alt="" />
                  <div class="portfolio-info">
            ...
            <div class="col-xl-4 col-md-6 portfolio-item filter-books">
              <div class="portfolio-wrap">
                <a href="<?php echo get_template_directory_uri(); ?>/assets/images/portfolio/product-4.jpg"
                  data-gallery="portfolio-gallery-app" class="glightbox"><img
                    src="<?php echo get_template_directory_uri(); ?>/assets/images/portfolio/product-4.jpg"
                    class="img-fluid" alt="" />
                  <div class="portfolio-info">
                    <h4>IT Solutions</h4>
                  </div>
            ...
            <div class="col-xl-4 col-md-6 portfolio-item filter-app">
              <div class="portfolio-wrap">
                <a href="<?php echo get_template_directory_uri(); ?>/assets/images/portfolio/product-5.jpg"
                  data-gallery="portfolio-gallery-app" class="glightbox"><img
                    src="<?php echo get_template_directory_uri(); ?>/assets/images/portfolio/product-5.jpg"
                    class="img-fluid" alt="" />
                  <div class="portfolio-info">
            ...
            <div class="col-xl-4 col-md-6 portfolio-item filter-branding">
              <div class="portfolio-wrap">
                <a href="<?php echo get_template_directory_uri(); ?>/assets/images/portfolio/product-6.jpg"
                  data-gallery="portfolio-gallery-app" class="glightbox"><img
                    src="<?php echo get_template_directory_uri(); ?>/assets/images/portfolio/product-6.jpg"
                    class="img-fluid" alt="" />
                  <div class="portfolio-info">
        ...
        <div class="row">
          ...
          <div class="col-md-6 left">
            <div class="list-wrap" data-aos="fade-up" data-aos-delay="100">
              ...
              <div class="icon bg-primary card-rotated">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/icons/icon-1.svg" alt="icon" />
              </div>
            </div>
            ...
            <div class="list-wrap" data-aos="fade-up" data-aos-delay="400">
              ...
              <div class="icon bg-secondary card-rotated">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/icons/icon-2.svg" alt="icon" />
              </div>
            </div>
            ...
            <div class="list-wrap" data-aos="fade-up" data-aos-delay="500">
              ...
              <div class="icon bg-success">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/icons/icon-3.svg" alt="icon" />
              </div>
            </div>
          </div>
          <!-- end  left -->
          ...
          <div class="col-md-6 right">
            <div class="list-wrap" data-aos="fade-up" data-aos-delay="100">
              <div class="icon bg-danger">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/icons/icon-4.svg" alt="icon" />
              </div>
              <div class="description">
                <h4>Pricing</h4>
                <p>
            ...
            <div class="list-wrap" data-aos="fade-up" data-aos-delay="200">
              <div class="icon bg-warning card-rotated">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/icons/icon-5.svg" alt="icon" />
              </div>
              <div class="description">
                <h4>Delivery</h4>
                <p>
            ...
            <div class="list-wrap" data-aos="fade-up" data-aos-delay="500">
              <div class="icon bg-info card-rotated">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/icons/icon-6.svg" alt="icon" />
              </div>
              <div class="description">
                <h4>Support</h4>
                <p>
    ...
    <div class="col-lg-4 col-md-12" data-aos="fade-up" data-aos-delay="100">
      <div class="pricing-card modern-card">
        ...
        <ul class="features">
          <li>
            <i class="bi bi-check-circle-fill"></i> Unlimited GB Space
          </li>
          <li>
            <i class="bi bi-check-circle-fill"></i> 30 Domain Names
          </li>
          <li><i class="bi bi-check-circle-fill"></i> Free SSL</li>
          <li>
            <i class="bi bi-check-circle-fill"></i> Daily Backup
          </li>
          <li class="cross-line">
            <i class="bi bi-x-circle-fill"></i> Free Templates
          </li>
          <li class="cross-line">
            <i class="bi bi-x-circle-fill"></i> Live Support
          </li>
        </ul>
        <a href="#" class="btn-get-started">Order Now</a>
      </div>
    </div>

    <div class="col-lg-4 col-md-12" data-aos="fade-up" data-aos-delay="200">
      <div class="pricing-card modern-card highlighted">
        <div class="card-header">
          <h3>Standard</h3>
          <div class="price">
            <h4><sup>$</sup>50</h4>
        ...
        <ul class="features">
          ...
          <li>
            <i class="bi bi-check-circle-fill"></i> Free Templates
          </li>
          <li class="cross-line">
            <i class="bi bi-x-circle-fill"></i> Live Support
          </li>
    ...
    <div class="col-lg-4 col-md-12" data-aos="fade-up" data-aos-delay="300">
      <div class="pricing-card modern-card premium">
        <div class="card-header">
          <h3>Premium</h3>
          <div class="price">
            <h4><sup>$</sup>100</h4>
        ...
        <ul class="features">
          ...
          <li>
            <i class="bi bi-check-circle-fill"></i> Live Support
          </li>
        </ul>
        <a href="#" class="btn-get-started">Order Now</a>
      </div>
          ...
          <div class="swiper-wrapper">
            <div class="swiper-slide">
              <div class="testimonial-wrap">
                <div class="testimonial-item modern">
                  <div class="info-box">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/testimonials/testimonial-1.jpg"
                  ...
                  <p class="testimonial-text">
                    ...
                    The service was exceptional and exceeded my expectations.
                    Highly recommend!
            ...
            <div class="swiper-slide">
              <div class="testimonial-wrap">
                <div class="testimonial-item modern">
                  <div class="info-box">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/testimonials/testimonial-2.jpg"
                      class="testimonial-img" alt="" />
                    <div>
                      <h3>Afa Rose</h3>
                      <h4>Web Designer</h4>
                  ...
                  <p class="testimonial-text">
                    <i class="bi bi-quote quote-icon-left"></i>
                    A seamless experience with outstanding support. Absolutely
                    love it!
                    <i class="bi bi-quote quote-icon-right"></i>
                  </p>
                </div>
            ...
            <div class="swiper-slide">
              <div class="testimonial-wrap">
                <div class="testimonial-item modern">
                  <div class="info-box">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/testimonials/testimonial-3.jpg"
                      class="testimonial-img" alt="" />
                    <div>
                      <h3>Keena Lara</h3>
                      <h4>Store Owner</h4>
                  ...
                  <p class="testimonial-text">
                    <i class="bi bi-quote quote-icon-left"></i>
                    This company truly understands customer needs and delivers
                    with excellence.
                    <i class="bi bi-quote quote-icon-right"></i>
                  </p>
                </div>
            ...
            <div class="swiper-slide">
              <div class="testimonial-wrap">
                <div class="testimonial-item modern">
                  <div class="info-box">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/testimonials/testimonial-4.jpg"
                      class="testimonial-img" alt="" />
                    <div>
                      <h3>Fizzi Brandon</h3>
                      <h4>Freelancer</h4>
                  ...
                  <p class="testimonial-text">
                    <i class="bi bi-quote quote-icon-left"></i>
                    A top-notch experience with great attention to detail.
                    Highly recommended!
                    <i class="bi bi-quote quote-icon-right"></i>
                  </p>
                </div>
        ...
        <div class="row g-4 align-items-center justify-content-center">
          ...
          <div class="col-lg-3 col-md-6">
            <div class="stats-box" data-aos="zoom-in" data-aos-delay="100">
              ...
              <div class="stats-icon">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/icons/happy-clients.svg"
                  alt="Happy Clients" />
              </div>
              <div class="stats-content">
                <h3 class="stats-number purecounter" data-purecounter-start="0" data-purecounter-end="232"
                  data-purecounter-duration="1">
                  232
                </h3>
                <p class="stats-label">Happy Clients</p>
                <small>Consequuntur quae diredo</small>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-3 col-md-6">
            <div class="stats-box" data-aos="zoom-in" data-aos-delay="200">
              <div class="stats-layer"></div>
              <div class="stats-icon">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/icons/complete-projects.svg"
                  alt="Completed Projects" />
              </div>
              <div class="stats-content">
                <h3 class="stats-number purecounter" data-purecounter-start="0" data-purecounter-end="521"
                  data-purecounter-duration="1">
                  521
                </h3>
                <p class="stats-label">Completed Projects</p>
                <small>Adipisci atque quia aut</small>
              </div>
            </div>
          </div>
          ...
          <!-- Stat Item -->
          <div class="col-lg-3 col-md-6">
            <div class="stats-box" data-aos="zoom-in" data-aos-delay="300">
              <div class="stats-layer"></div>
              <div class="stats-icon">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/icons/hours-support.svg"
                  alt="Hours of Support" />
              </div>
              <div class="stats-content">
                <h3 class="stats-number purecounter" data-purecounter-start="0" data-purecounter-end="453"
                  data-purecounter-duration="1">
                  453
                </h3>
                <p class="stats-label">Hours of Support</p>
                <small>Aut commodi quaerat</small>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="container" data-aos="zoom-out">
        <div class="clients-slider swiper">
          <div class="swiper-wrapper align-items-center">
            <div class="swiper-slide">
              <img src="<?php echo get_template_directory_uri(); ?>/assets/images/clients/client-1.png"
                class="img-fluid" alt="" />
            </div>
            <div class="swiper-slide">
              <img src="<?php echo get_template_directory_uri(); ?>/assets/images/clients/client-2.png"
                class="img-fluid" alt="" />
            </div>
            <div class="swiper-slide">
              <img src="<?php echo get_template_directory_uri(); ?>/assets/images/clients/client-3.png"
                class="img-fluid" alt="" />
            </div>
            <div class="swiper-slide">
              <img src="<?php echo get_template_directory_uri(); ?>/assets/images/clients/client-4.png"
                class="img-fluid" alt="" />
            </div>
            <div class="swiper-slide">
              <img src="<?php echo get_template_directory_uri(); ?>/assets/images/clients/client-5.png"
                class="img-fluid" alt="" />
            </div>
            <div class="swiper-slide">
              <img src="<?php echo get_template_directory_uri(); ?>/assets/images/clients/client-6.png"
                class="img-fluid" alt="" />
            </div>
            <div class="swiper-slide">
              <img src="<?php echo get_template_directory_uri(); ?>/assets/images/clients/client-7.png"
                class="img-fluid" alt="" />
            </div>
            <div class="swiper-slide">
              <img src="<?php echo get_template_directory_uri(); ?>/assets/images/clients/client-8.png"
                class="img-fluid" alt="" />
            </div>
          </div>
        </div>
    ...
    <section id="team" class="team section-gradient">
      <div class="container" data-aos="fade-up">
        ...
        <div class="row gy-5 justify-content-center">
          ...
          <div class="col-xl-3 col-md-6 team-member" data-aos="fade-up" data-aos-delay="100">
            <div class="member-card position-relative shadow">
              <div class="member-image">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/team/team-1.jpg" alt="Jhone Bi" />
          ...
          <!-- Team Member -->
          <div class="col-xl-3 col-md-6 team-member" data-aos="fade-up" data-aos-delay="200">
            <div class="member-card position-relative shadow">
              <div class="member-image">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/team/team-2.jpg"
                  alt="Sani Awesome" />
                <div class="overlay-gradient"></div>
              </div>
              <div class="member-info p-4 text-center">
          ...
          <!-- Team Member -->
          <div class="col-xl-3 col-md-6 team-member" data-aos="fade-up" data-aos-delay="300">
            <div class="member-card position-relative shadow">
              <div class="member-image">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/team/team-3.jpg"
                  alt="Andrio Willi" />
                <div class="overlay-gradient"></div>
              </div>
              <div class="member-info p-4 text-center">
          ...
          <!-- Team Member -->
          <div class="col-xl-3 col-md-6 team-member" data-aos="fade-up" data-aos-delay="400">
            <div class="member-card position-relative shadow">
              <div class="member-image">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/team/team-4.jpg" alt="Afa Jonson" />
                <div class="overlay-gradient"></div>
              </div>
              <div class="member-info p-4 text-center">
                <h4>Afa Jonson</h4>
    ...
    <section id="faq" class="faq sections-bg">
      <div class="container" data-aos="fade-up">
        <div class="section-header">
          ...
          <p>Your questions answered clearly and effectively</p>
        </div>
          ...
          <div class="accordion" id="faqAccordion">
            ...
            <div class="accordion-item">
              ...
              <div id="faq1" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                <div class="accordion-body">
                  Web domain and hosting are the backbone of a website, where
                  the domain is the address, and hosting is the server where
            ...
            <div class="accordion-item">
              ...
              <div id="faq2" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                <div class="accordion-body">
                  Linux is generally better for stability and cost, while
                  Windows is great for .NET applications and integration with
                  Microsoft products.
                </div>
              </div>
            </div>
            ...
            <div class="accordion-item">
              <h3 class="accordion-header">
                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                  data-bs-target="#faq3">
                  <span class="icon"><i class="bi bi-question-circle-fill"></i></span>
                  Google Cloud or Amazon server: which is better and faster?
                </button>
              </h3>
              <div id="faq3" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                <div class="accordion-body">
                  Both offer excellent speed and reliability, but the choice
                  depends on specific needs like pricing, features, and
                  scalability.
                </div>
              </div>
            </div>
            ...
            <div class="accordion-item">
              <h3 class="accordion-header">
                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                  data-bs-target="#faq4">
                  <span class="icon"><i class="bi bi-question-circle-fill"></i></span>
                  Why is organic SEO important for all businesses?
                </button>
              </h3>
              <div id="faq4" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                <div class="accordion-body">
                  Organic SEO drives long-term traffic, builds trust with
                  users, and reduces the dependency on paid ads for
                  visibility.
                </div>
              </div>
            </div>
    ...
    <section id="recent-posts" class="recent-posts sections-bg">
      <div class="container" data-aos="fade-up">
        <div class="section-header text-center">
          ...
          <p>Stay updated with the latest industry trends and insights.</p>
        </div>
        <div class="row gy-4">
          <div class="col-lg-4 col-md-6">
            <article class="post-card">
              <div class="post-img">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/blog/blog-1.jpg" alt="Blog 1"
                  class="img-fluid" />
              </div>
              <p class="post-category">Domain & Hosting</p>
              <h3 class="post-title">
                <a href="blog-details.html">How to Host a Website on Any Hosting Provider?</a>
              </h3>
              <div class="post-meta">
                <p class="post-author">William Bla</p>
                <p class="post-date">
                  <time datetime="2025-01-01">Feb 1, 2025</time>
                </p>
              </div>
            </article>
          </div>
          ...
          <div class="col-lg-4 col-md-6">
            <article class="post-card">
              <div class="post-img">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/blog/blog-2.jpg" alt="Blog 2"
                  class="img-fluid" />
              </div>
              <p class="post-category">Advertisement</p>
              <h3 class="post-title">
                <a href="blog-details.html">How to Create Ads on Google AdWords?</a>
              </h3>
              <div class="post-meta">
                <p class="post-author">Jobi Ret</p>
                <p class="post-date">
                  <time datetime="2025-01-01">Oct 5, 2025</time>
                </p>
              </div>
            </article>
          </div>
          ...
          <div class="col-lg-4 col-md-6">
            <article class="post-card">
              <div class="post-img">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/blog/blog-3.jpg" alt="Blog 3"
                  class="img-fluid" />
              </div>
